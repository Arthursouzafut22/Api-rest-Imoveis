...
Router.post("/cadastrar", (req, res) => {
  ...
  uploadeFiles(req, res, files, () => {
    const query = `INSERT INTO imoveis (nome, tipo, camas, banheiros, metros_quadrados, imagens, mes, localizacao, diaria, semanal, descricao, comodidades, em_destaque, recem_adicionados, meus_imoveis)
        VALUES 
